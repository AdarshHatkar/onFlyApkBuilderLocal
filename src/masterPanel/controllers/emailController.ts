...
class emailController {
    ...
    static sendVerificationEmailValidationRules = () => {
        return [
    ...
    static sendVerificationEmail = async (req, res) => {
        try {
            ...
            const sendMail = await mailTransporter.sendMail({
                from: '"Primexop" <no-reply@primexop.com>', // sender address
                ...
                text: 'contact our customer support for help Primexop.com', // plain text body
                html: `
                <html>
                <head>
    ...
    static checkVerificationLinkValidationRules = () => {
        return [
    ...
    static checkVerificationLink = async (req, res) => {
    ...
    static sendPasswordResetEmailValidationRules = () => {
        return [
    ...
    static checkPasswordResetLinkValidationRules = () => {
        return [
    ...
    static checkPasswordResetLink = async (req, res) => {
